...
BEGIN
	...
	EXEC sys.sp_addextendedproperty @name=N'MS_Description', @value=N'ignore values with "child"' , @level0type=N'SCHEMA',@level0name=N'dbo', @level1type=N'TABLE',@level1name=N'LOG_SCHEDULER', @level2type=N'COLUMN',@level2name=N'NODE_ID'
END
